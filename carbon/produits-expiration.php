...
<body>
    ...
    <div class="relative top-12 m-12">
        <h1
            class="text-center mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-4xl dark:text-white">
            Les produits qui sont dans le dépôt
        </h1>
        ...
        <div class="relative overflow-x-auto">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 whitespace-nowrap">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-blue-400 dark:border-gray-700 text-gray-900">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php echo $produit['date_enregistrement'] ?>
                            <br>
                            <?php echo diffForHumans($produit['date_enregistrement']) ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php echo $produit['date_expiration'] ?>
                            <br>
                            <?php echo badge($produit['date_expiration']) ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
